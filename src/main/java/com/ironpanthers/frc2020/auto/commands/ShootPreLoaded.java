...
import com.ironpanthers.frc2020.Constants.Conveyor;
...
public class ShootPreLoaded extends SequentialCommandGroup {
	...
	public ShootPreLoaded(Arm arm, int target, Shooter shooter, int velocity, int threshold, ConveyorBelt conveyor) {
		...
		super(new ArmAndSpinShooter(arm, target, shooter, velocity, threshold), new ShooterSequence(shooter, conveyor, velocity, threshold));
	}
}
