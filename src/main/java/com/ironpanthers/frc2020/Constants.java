...
public final class Constants {
    ...
    public static class Conveyor {
		...
		public static final double kConveyorInSpeed = -0.75;
    ...
    public static class Arm {
        ...
        public static final double kP = 2.5; // Needs testing, 2.0 did not get to the target
        ...
        // Setpoints
        public static final double kPositionErrorTolerance = 1; // 2.5 way too high
